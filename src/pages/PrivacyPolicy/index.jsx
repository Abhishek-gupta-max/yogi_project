...
export default function PrivacyPolicy() {
  useDocumentTitle('Privacy Policy | DEVELTRIXSECURE', 'Privacy Policy and data protection practices for DEVELTRIXSECURE TECHNOLOGIES LLP.');
        ...
        >
          <div className="space-y-8">
            <section>
              ...
              <p>
                DEVELTRIXSECURE TECHNOLOGIES LLP ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 p-4 rounded-xl" style={{ background: 'rgba(0, 87, 255, 0.05)', border: '1px solid rgba(0, 87, 255, 0.15)' }}>
                <p className="text-text-primary font-semibold">DEVELTRIXSECURE TECHNOLOGIES LLP</p>
